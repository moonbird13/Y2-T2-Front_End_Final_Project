...
const placeholderImages = {
  ...
  disability: 'https://gcp-na-images.contentstack.com/v3/assets/bltea6093859af6183b/blt09f1c0ba2575f09d/698a117c97cdff34346bb13b/disability-kindness-01-vertical.jpg?branch=production',
  pets: 'https://images.unsplash.com/photo-1548199973-03cce0bbc87b?auto=format&fit=crop&w=1200&q=80',
  allergy: 'https://asthmaallergyclinic.in/wp-content/uploads/2023/02/0002c1431e73be4aeca346283beff011.jpg',
  none: 'https://www.fabhotels.com/blog/wp-content/uploads/2020/05/road-trip-hacks-tips-600.jpg',
  ...
  walking: 'https://media.guruwalk.com/9mm98te3bq1op8mjtsj1vimkqsqk',
  motorbike: 'https://cdn.hstatic.net/products/200000216059/z7390532095136_94b48c2c90bbca87010c52644426830b_7686f65d8bc24409acf1f9bc92715d11_master.jpg',
  car: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=1200&q=80',
  tuktuk: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2b/85/b2/f4/my-tuktuk-service-in.jpg?w=1200&h=-1&s=1',
...
const baseQuizQuestions = [
  ...
  // Q2: Special conditions (conditional answers based on Q1)
  {
    ...
    answersSolo: [
      ...
      { id: 'allergy', label: 'Have allergy', image: placeholderImages.allergy },
    ...
    answersGroup: [
      ...
      { id: 'allergy', label: 'Person with allergy', image: placeholderImages.allergy },
      { id: 'none', label: 'None', image: placeholderImages.none },
    ],
    nextQuestion: 3,
  },
